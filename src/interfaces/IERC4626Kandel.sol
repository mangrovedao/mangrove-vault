...
interface IERC4626Kandel {
  ...
  function adminWithdrawTokens(IERC20 token, uint256 amount, address recipient) external;
  ...
  function setVaultForToken(IERC20 token, IERC4626 vault, uint256 minAssetsOut, uint256 minSharesOut) external;
