...
import {MangroveERC4626KandelVault} from "../../src/integrations/MangroveERC4626KandelVault.sol";
import {Tick, KandelPosition, FundsState, Params} from "../../src/MangroveVault.sol";
...
import {MangroveERC4626KandelVaultFactory} from "../../src/integrations/MangroveERC4626KandelVaultFactory.sol";
...
contract MangroveERC4626KandelVaultTest is Test {
  ...
  MangroveERC4626KandelVaultFactory public factory;
  ...
  function setUp() public {
    ...
    factory = new MangroveERC4626KandelVaultFactory();
  ...
  function deployVault(uint8 market)
    internal
    returns (MangroveERC4626KandelVault vault, MarketWOracle memory _market, address kandel)
  {
  ...
  function mintWithSpecifiedQuoteAmount(
    MangroveERC4626KandelVault vault,
    MarketWOracle memory _market,
    uint256 quoteAmount
  ) internal returns (uint256 baseAmountOut, uint256 quoteAmountOut, uint256 shares) {
  ...
  function testFuzz_initialMintAmountMatch(uint8 market, uint128 quote) public {
    ...
    (MangroveERC4626KandelVault vault, MarketWOracle memory _market,) = deployVault(market);
  ...
  function test_auth() public {
    (MangroveERC4626KandelVault vault,,) = deployVault(0);
  ...
  function test_swap() public {
    ...
    MangroveERC4626KandelVaultTest(address(this)).swapMock(WETH, USDC, 1 ether, 3000e6);
    vm.stopPrank();
  ...
  function test_swapIncorrectSlippageParam() public {
    (MangroveERC4626KandelVault vault, MarketWOracle memory _market,) = deployVault(0);
  ...
  function test_aave() public {
    (MangroveERC4626KandelVault vault, MarketWOracle memory _market,) = deployVault(0, aaveKandelSeeder);
